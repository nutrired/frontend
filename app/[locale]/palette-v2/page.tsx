        ...
        <div className="hero-right">
          ...
          <div className="hero-blob">
            <svg viewBox="0 0 640 760" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
              <path d="M600 0H640V760H90C90 760-10 690 20 560 50 430 145 405 160 295 175 185 105 95 195 28 285-39 400 12 490 3 545-3 580 0 600 0Z" fill="#1F3C4D" />
            </svg>
          </div>

          {/* Grain texture over teal-blue */}
          ...
          <div className="hero-photo">
            <svg viewBox="0 0 280 380" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
              ...
              <ellipse cx="194" cy="68" rx="26" ry="46" fill="rgba(63,175,122,0.38)" transform="rotate(-28 194 68)" />
              <ellipse cx="86"  cy="60" rx="22" ry="38" fill="rgba(63,175,122,0.28)" transform="rotate(22 86 60)" />
              <ellipse cx="224" cy="108" rx="18" ry="32" fill="rgba(63,175,122,0.22)" transform="rotate(-45 224 108)" />
              ...
              <circle cx="190" cy="170" r="10" fill="rgba(168,230,207,0.50)" />
              <circle cx="90"  cy="185" r="7"  fill="rgba(168,230,207,0.35)" />
            </svg>
          </div>
            ...
            <div className="nut-photo">
              <div className="nut-photo-bg bg-green">
                <svg className="nut-figure" viewBox="0 0 140 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <ellipse cx="108" cy="28" rx="14" ry="26" fill="rgba(63,175,122,0.5)" transform="rotate(-28 108 28)" />
                  <ellipse cx="32"  cy="38" rx="11" ry="20" fill="rgba(63,175,122,0.4)" transform="rotate(22 32 38)" />
          ...
          <div className="nut-card reveal">
            <div className="nut-photo">
              <div className="nut-photo-bg bg-terra">
                <svg className="nut-figure" viewBox="0 0 140 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <ellipse cx="112" cy="24" rx="15" ry="27" fill="rgba(168,230,207,0.45)" transform="rotate(-22 112 24)" />
                  <ellipse cx="28"  cy="36" rx="12" ry="21" fill="rgba(168,230,207,0.35)" transform="rotate(28 28 36)" />
                  <circle cx="70" cy="58" r="34" fill="rgba(245,240,232,0.28)" />
                  <path d="M20 200 Q20 138 70 128 Q120 138 120 200" fill="rgba(245,240,232,0.22)" />
                </svg>
              </div>
          ...
          <div className="nut-card reveal">
            <div className="nut-photo">
              <div className="nut-photo-bg bg-slate">
                <svg className="nut-figure" viewBox="0 0 140 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <ellipse cx="110" cy="26" rx="14" ry="25" fill="rgba(31,60,77,0.45)" transform="rotate(-26 110 26)" />
                  <ellipse cx="30"  cy="37" rx="11" ry="20" fill="rgba(31,60,77,0.35)" transform="rotate(25 30 37)" />
                  <circle cx="70" cy="58" r="34" fill="rgba(245,240,232,0.28)" />
                  <path d="M20 200 Q20 138 70 128 Q120 138 120 200" fill="rgba(245,240,232,0.22)" />
                </svg>
              </div>
